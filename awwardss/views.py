...
from .forms import PostForm,SignupForm, UpdateUserForm,UpdateUserProfileForm,UpdateUserProfileForm,RatingsForm
...
def search_project(request):
    if request.method == 'GET':
        ...
        results = Post.objects.filter(title =title).all()
        print(results)
        message = f'name'
        params = {
            'results': results,
